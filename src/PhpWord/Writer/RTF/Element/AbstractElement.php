...
use WH\PhpWord\Style\Paragraph as ParagraphStyle;
use WH\PhpWord\Writer\AbstractWriter;
use WH\PhpWord\Writer\HTML\Element\AbstractElement as HTMLAbstractElement;
use WH\PhpWord\Writer\RTF\Style\Font as FontStyleWriter;
use WH\PhpWord\Writer\RTF\Style\Paragraph as ParagraphStyleWriter;
...
abstract class AbstractElement extends HTMLAbstractElement
{
    ...
    {
        /** @var \WH\PhpWord\Writer\RTF $parentWriter Type hint */
