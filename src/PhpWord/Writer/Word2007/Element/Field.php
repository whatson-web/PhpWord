...
class Field extends Text
{
    ...
    public function write()
    {
        ...
        if (!$element instanceof \WH\PhpWord\Element\Field) {
            return;
        }
    ...
    private function writeDefault(\WH\PhpWord\Element\Field $element)
    {
        ...
        if ($element->getText() != null) {
            if ($element->getText() instanceof \WH\PhpWord\Element\TextRun) {
     ...
     * @param \WH\PhpWord\Element\Field $element
     */
    protected function writeMacrobutton(\WH\PhpWord\Element\Field $element)
    {
        $xmlWriter = $this->getXmlWriter();
        $this->startElementP();
    ...
    private function buildPropertiesAndOptions(\WH\PhpWord\Element\Field $element)
    {
