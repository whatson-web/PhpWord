 ...
 *
 * @method \WH\PhpWord\Element\OLEObject addObject(string $source, mixed $style = null) deprecated, use addOLEObject instead
 *
 * @since 0.10.0
 */
abstract class AbstractContainer extends AbstractElement
{
    ...
    protected function addElement($elementName)
    {
        ...
        /** @var \WH\PhpWord\Element\AbstractElement $element Type hint */
     ...
     *
     * @param int $index
     * @return \WH\PhpWord\Element\AbstractElement|null
     */
     ...
     *
     * @param int|\WH\PhpWord\Element\AbstractElement $toRemove
     */
    public function removeElement($toRemove)
    {
        ...
        } elseif ($toRemove instanceof \WH\PhpWord\Element\AbstractElement) {
     ...
     * @param mixed $paragraphStyle
     *
     * @return \WH\PhpWord\Element\Footnote
     *
     * @codeCoverageIgnore
     */
