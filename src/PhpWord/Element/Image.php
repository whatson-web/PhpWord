...
use WH\PhpWord\Exception\InvalidImageException;
use WH\PhpWord\Exception\UnsupportedImageTypeException;
use WH\PhpWord\Settings;
use WH\PhpWord\Shared\ZipArchive;
use WH\PhpWord\Style\Image as ImageStyle;
...
class Image extends AbstractElement
{
     ...
     * @param string $name
     *
     * @throws \WH\PhpWord\Exception\InvalidImageException
     * @throws \WH\PhpWord\Exception\UnsupportedImageTypeException
     */
