...
use WH\PhpWord\Exception\InvalidObjectException;
...
class OLEObject extends AbstractElement
{
     ...
     * @param mixed $style
     *
     * @throws \WH\PhpWord\Exception\InvalidObjectException
     */
