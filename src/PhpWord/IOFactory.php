...
use WH\PhpWord\Reader\ReaderInterface;
...
abstract class IOFactory
{
     ...
     * @throws \WH\PhpWord\Exception\Exception
     *
     * @return \WH\PhpWord\Writer\WriterInterface|\WH\PhpWord\Reader\ReaderInterface
     */
    private static function createObject($type, $name, $phpWord = null)
    {
        $class = "WH\\PhpWord\\{$type}\\{$name}";
     ...
     * @return \WH\PhpWord\PhpWord $phpWord
     */
    public static function load($filename, $readerName = 'Word2007')
    {
        /** @var \WH\PhpWord\Reader\ReaderInterface $reader */
